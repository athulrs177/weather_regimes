...
This repository contains the Python-based scritps for computing and detecting weather regimes as explain in Grams et al. 2017 (Balancing Europe’s wind-power output through spatial deployment informed by weather regimes).
